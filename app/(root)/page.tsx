...
import { getCurrentUserRole, onBoardUser } from "@/modules/auth/actions";
...
export default async function Home() {
  ...
  const features = [
    {
      ...
      title: "Feel Like a coding champ",
      description: "Our platform is designed to help you feel like a coding champ. We provide you with the tools and resources you need to succeed.",
    },
    {
    ...
    },
    {
      ...
      description: "Join a global community of coders and learn from each other.",
    },
    {
      icon: <Settings className="h-4 w-4" />,
      title: "Real-time feedback",
      description: "Get real-time feedback on your code and improve your skills.",
    }
  ]
  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      <Navbar userRole={await getCurrentUserRole() || 'user'} />
        ...
        <Badge
          ...
          <h1 className="text-2xl md:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white leading-tight mb-8">
            <span className="relative inline-block">
              <span className="px-6 py-3 bg-amber-500 dark:bg-amber-400 text-white dark:text-gray-900 rounded-2xl transform -rotate-[5deg] inline-block shadow-lg">
                Solving
              </span>
            </span>{" "}
            Problems
            ...
            with{" "}
            <span className="relative inline-block">
              <span className="px-6 py-3 bg-indigo-600 dark:bg-indigo-500 text-white rounded-2xl transform rotate-[5deg] inline-block shadow-lg">
                Code
              </span>
            </span>
          </h1>

          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl text-center mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {problemStats.map((stat) => (
              <div key={stat.label} className="flex flex-col items-center justify-center">
                <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">{stat.number}</h2>
